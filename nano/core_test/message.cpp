...
// Test that message header serialization/deserialization works correctly with live network
// This validates that the magic_number() function is properly used for live network
TEST (message, header_live_network_magic_number)
{
